/**
  Class for a person with name and dates of birth and death
  Class invariant: A Person always has a date of birth, and 
  if the Person has a date of death it is always equal to
...
public class Person {
  ...
  */
  private void setDeathYear(int newYear) {
    if (died == null) {
      System.out.println("Fatal Error. Aborting.");
      System.exit(0);
    } 
  ...
  /**
    ...
    (deathDate == null), that is consistent with and birthDate.
