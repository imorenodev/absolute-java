...
public class DateFinal { 
  ...
  public DateFinal(int monthInt, int day, int year) {
    setDate(monthInt, day, year);
  }

  public DateFinal(String monthString, int day, int year) {
    setDate(monthString, day, year);
  }

  public DateFinal(int year) {
    setDate(1, 1, year);
  }

  public DateFinal(DateFinal aDate) {
    if (aDate == null) {
  ...
  */
  ...
  public boolean equals(DateFinal otherDate) {
    return ((this.month.equals(otherDate.month)) &&
            (this.day == otherDate.day) && 
            (this.year == otherDate.year));
  }

  public boolean precedes(DateFinal otherDate) {
